        ...
        <div class="row">
            <div class="col-6">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card w-75">
                            <img class="card-img-top" id="productImage" />
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group row">
                                <input class="form-control form-control-lg" type="text" name="productName" placeholder="Име на продукта">
                            </div>
                
                            <div class="form-group row">
                                <input class="form-control form-control-lg" type="number" step="0.01" name="productPrice" placeholder="Цена">
                            </div>

                            <div class="row">
                                <button type="submit" class="btn btn-primary btn-lg btn-block">Добави</button>
                            </div>
                        </div>
                    </div>                
                </div>
